...
public class GeometryUtils {
    ...
    public static Radius calculateByDirection(Double baseLatitude, Double baseLongitude, double distance,
                                                Double bearing) {
        ...
        return new Radius(toDegree(latitude), toDegree(longitude));
    }
