package com.sparta.mbti.security.filter;

import com.sparta.mbti.security.jwt.HeaderTokenExtractor;
import com.sparta.mbti.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    protected void unsuccessfulAuthentication(
        ...
        /*
         *	로그인을 한 상태에서 Token 값을 주고받는 상황에서 잘못된 Token 값이라면
         *	인증이 성공하지 못한 단계이기 때문에 잘못된 Token 값을 제거합니다.
